		...
		<ul class="nav" id="side-menu">
			...
			<li><a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> <fmt:message
				...
				<ul class="nav nav-second-level">
					...
					<li><a href="flot.html"> <fmt:message
			...
			<li><a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> <fmt:message
				...
				<ul class="nav nav-second-level">
					<li><a href="flot.html"> <fmt:message
								key="common.fournisseur" />
					</a></li>
					<li><a href="flot.html"> <fmt:message
								key="common.fournisseur.commande" />
					</a></li>
				</ul> <!-- /.nav-second-level --></li>
			...
			<li><a href="#"><i class="fa fa-wrench fa-fw"></i> <fmt:message
				...
				<ul class="nav nav-second-level">
					<li><a href="panels-wells.html"> <fmt:message
								key="common.parametrage.utilisateur" />
					</a></li>
					<li><a href="buttons.html"> <fmt:message
								key="common.parametrage.categorie" />
					</a></li>
					<li><a href="notifications.html"> <fmt:message
								key="common.parametrage" />
					</a></li>
